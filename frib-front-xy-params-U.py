...
#     phase-space area. 
#
# Each ion species assumed to be born from a neutral to its full charge state instantly at birth. 
...
#    statistical canonical angular momentum in birth_mode = 1,2  
...
rms_birth = r_extractor/2.   # Same birth radius as source aperture size (factor 2 due to rms x equiv)
bz0_birth = 1.2              # Average field between Venus ECR peaks   
...
#  *  <P_theta>_j in norm emittance units <P_theta>_j/(m_j*c) [m-rad]

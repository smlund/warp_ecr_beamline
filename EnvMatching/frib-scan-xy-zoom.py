...
i1, i2 = runcounter(ensembles=[19])

# Peak on-axis B-field of the two solenoids (in Telsa)

s4p1_str = 0.51 + 0.005*i1
s4p2_str = 0.42 + 0.005*i2
...
outfile = open("ScanSC75Zoom.out", "a")

outputdata = array([s4p1_str, s4p2_str, u34_beta, u34_alpha, hl_eff_end[u34_js]/2., hl_eff_n[u34_js]/2.])
savetxt(outfile, outputdata[newaxis])
